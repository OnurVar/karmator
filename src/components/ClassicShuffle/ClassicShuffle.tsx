...
import './ClassicShuffle.css'

const DEFAULT_NAME_COUNT = 14
...
function ClassicShuffle() {
  ...
  const generateRandomResult = (validNames: string[]): ShuffleResult => {
  ...
  return (
    <div className="classic-shuffle">
      {/* Results Section */}
      <div className="classic-shuffle-results">
        <TeamResult
          result={result}
      ...
      {/* Inputs Section */}
      <div className="classic-shuffle-inputs">
